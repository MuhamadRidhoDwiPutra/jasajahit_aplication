...
class CekDetailRiwayatBajuCustomerScreen extends StatelessWidget {
  final Order order;
  const CekDetailRiwayatBajuCustomerScreen({super.key, required this.order});
  ...
  Widget build(BuildContext context) {
    ...
    final model = firstItem['jenisBaju'] ?? '-';
                ...
                children: [
                  ...
                  if (order.items.length > 1) ...[
                    ...
                    ...order.items.asMap().entries.map((entry) {
                      ...
                      final itemModel = item['jenisBaju'] ?? '-';
